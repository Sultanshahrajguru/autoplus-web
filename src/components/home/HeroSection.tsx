...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden border-b border-graphite-900/8 pt-28 sm:pt-32">
      ...
      <div className="absolute inset-y-0 right-0 hidden w-[44%] bg-[linear-gradient(135deg,transparent_0%,rgba(255,255,255,0.7)_28%,rgba(200,91,34,0.08)_100%)] lg:block" />
      <div className="section-wrap relative grid gap-10 pb-16 pt-8 lg:grid-cols-[minmax(0,1.12fr)_430px] lg:items-end lg:pb-24">
        <div className="flex flex-col gap-6 fade-up">
          ...
          <h1 className="max-w-4xl font-display text-5xl font-semibold uppercase leading-[0.88] tracking-tight text-graphite-950 text-balance sm:text-6xl lg:text-8xl">
        ...
        <div className="panel-dark relative overflow-hidden p-6 float-in sm:p-7">
          ...
          <div className="mt-6 space-y-4">
            <div className="rounded-2xl border border-graphite-900/8 bg-metal-100 p-4">
              ...
              <div className="flex items-center justify-between">
                <span className="font-medium text-graphite-950">Log Book Service</span>
            ...
            <div className="rounded-2xl border border-graphite-900/8 bg-metal-100 p-4">
              ...
              <div className="flex items-center justify-between">
                <span className="font-medium text-graphite-950">Nearest Victoria location</span>
            ...
            <div className="rounded-2xl border border-graphite-900/8 bg-metal-100 p-4">
              ...
              <div className="flex items-center justify-between">
                <span className="font-medium text-graphite-950">This week preferred</span>
          ...
          <div className="mt-6 rounded-[24px] border border-accent/25 bg-accent/10 p-5">
            ...
            <a
              className="mt-4 inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.14em] text-graphite-950"
              href="/contact"
            >
